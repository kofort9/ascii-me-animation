...
exports.FLIP_FRAME_DURATION = exports.FLIP_TOTAL_FRAMES = void 0;
exports.animateText = animateText;
exports.runFlipClockAnimation = runFlipClockAnimation;
 ...
 */
function buildPatternOrder(length, pattern) {
 ...
 */
function animateText(finalText, frame, pattern = 'matrix', order) {
    if (!finalText)
        return '';
    ...
    const resolvedThresholds = new Map();
 ...
 */
async function runFlipClockAnimation(trackName, artist, onFrame) {
...
exports.FLIP_TOTAL_FRAMES = TOTAL_FRAMES;
exports.FLIP_FRAME_DURATION = FRAME_DURATION_MS;
